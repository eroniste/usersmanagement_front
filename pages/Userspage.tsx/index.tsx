...
export default function Userspage({ usersFromServer }: any) {
  ...
  const { data, isLoading, error } = useSWR(
    `/users?page=${currentPage}&limit=${pageSize}&searchTerm=${searchTerm}`,
    fetcher,
    { key: "users" } as Partial<PublicConfiguration<any, any, any>>
  );
        ...
        <div className="container mx-auto px-4 sm:px-8">
          <div className="py-8">
            ...
            <div className="w-full my-2 flex justify-between">
              ...
              <div>
                <button
                  className="px-4 py-2 bg-gradient-to-r from-blue-500 to-blue-600 hover:opacity-80 text-white text-sm font-medium rounded-md m-2"
                            ...
                            <AlertDialog>
                              <AlertDialogTrigger className="w-full">
                                <TooltipProvider>
                                  <Tooltip>
                                    <TooltipTrigger>
                                      <AiTwotoneDelete className="text-red-600 w-5 h-5 "/>
                                    </TooltipTrigger>
                                    <TooltipContent>
                                      <p>Delete User</p>
                                    </TooltipContent>
                              ...
                              <AlertDialogContent>
                                ...
                                <AlertDialogFooter>
                                  ...
                                  <AlertDialogAction
                                    onClick={() => deleteUser(invoice._id)}
                                  >
                                    Confirm
                                  </AlertDialogAction>
                                </AlertDialogFooter>
...
const Pagination = ({ currentPage, totalPages, onPageChange }) => {
  return (
    <div className="flex space-x-2">
      ...
      <div className={`px-4 py-2 border border-gray-300 bg-white text-black`}>
        {currentPage}
      </div>
